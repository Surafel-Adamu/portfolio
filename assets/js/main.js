...
document.addEventListener("DOMContentLoaded", function () {
  ...
  magicContainer.classList.add("magic-elements");
  ...
  for (let i = 0; i < 10; i++) {
    ...
    orb.classList.add("magic-orb");
    orb.style.left = `${Math.random() * 100}vw`;
    orb.style.top = `${Math.random() * 100}vh`;
    orb.style.animationDuration = `${Math.random() * 6 + 3}s`;
    magicContainer.appendChild(orb);
  }
});
...
// Portfolio Drop Animation on Scroll
document.addEventListener("DOMContentLoaded", function () {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.body.appendChild(parallaxBackground);
